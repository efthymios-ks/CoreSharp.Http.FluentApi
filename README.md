...
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=efthymios-ks_CoreSharp.Http.FluentApi&metric=coverage)](https://sonarcloud.io/summary/new_code?id=efthymios-ks_CoreSharp.Http.FluentApi)
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=efthymios-ks_CoreSharp.Http.FluentApi&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=efthymios-ks_CoreSharp.Http.FluentApi)
![GitHub License](https://img.shields.io/github/license/efthymios-ks/CoreSharp.Http.FluentApi)
...
## Installation
Install the package with [Nuget](https://www.nuget.org/packages/CoreSharp.Http.FluentApi).
```
